...
function CommandList(){
    ...
    this.add = function() {
        ...
        this.array[this.count] = [command,component,monkeyId,args];
        this.count++;
    };
    this.addGet = function(component,monkeyId,property,variable) {
        this.array[this.count] = ["GetVariable",component,monkeyId,[property,variable]];
        this.count++;
    };
    this.addDriver = function(file) {
        this.driverCount();
        this.array[this.count] = ["DataDrive","","",[file]];
        this.count++;
    };
